...
final response = await _dio.post('https://aryamobileapi.000webhostapp.com/logout.php', data: fdata,);
prefs.remove('session_token');
  ...
  Future Login({required String username, required String password}) async {
    ...
    final response = await _dio.post('https://aryamobileapi.000webhostapp.com/login.php',data: fdata,);
    log("res $response");
